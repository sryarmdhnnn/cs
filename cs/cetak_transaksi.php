  ...
  <page size="dipakai" layout="landscape">
    ...
    ?>
      <center>
        ...
        <span>
          Jl. H. Icang no. 23 GG.Ampng 3, Kec. Cimanggis, Kab. Depok, Jawa Barat<br>
          Telp. +62 857-7785-0582 || E-mail sryarmdhnnn@gmail.com
        </span>
      </center>
            <hr>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $no_order_fiks = 1;
                    $query_order_fiks = "select * from tb_pesan natural join tb_minuman where id_order = $id_order";
