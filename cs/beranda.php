...
<html lang="en">
<head>
<title>EYDITH COFFEE SHOP</title>
<meta charset="UTF-8" />
...
<div id="sidebar"><a href="beranda.php" class="visible-phone"><i class="icon icon-home"></i> Home</a>
  ...
  <?php
    if($r['id_level'] == 1){
  ?>
    <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Home</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="beranda.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
<!--End-breadcrumbs-->
    ...
    ?>
      ...
      <div class="alert alert-orange alert-block">
        <center>
          ...
          Di Sistem Pelayanan Eydith Coffee Shop.
          <br> Semoga hari anda Menyenangkan dan Ceria selalu.
        </center>
      </div>
      <?php
        }
