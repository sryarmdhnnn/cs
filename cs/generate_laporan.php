          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <?php
                ...
                $query_lihat_menu = "select * from tb_minuman";
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $r_lihat_menu['nama_minuman'];?></td>
                  <td><center><?php echo $r_lihat_menu['stok'];?></center></td>
                  <td>
                    <center>
                      <?php
                        $id_minuman = $r_lihat_menu['id_minuman'];
                        $query_lihat_stok = "select * from tb_stok left join tb_pesan on tb_stok.id_pesan = tb_pesan.id_pesan left join tb_minuman on tb_pesan.id_minuman = tb_minuman.id_minuman where status_cetak = 'belum cetak'";
                        $query_jumlah = "select sum(jumlah_terjual) as jumlah_terjual from tb_stok left join tb_pesan on tb_stok.id_pesan = tb_pesan.id_pesan where id_minuman = $id_minuman and status_cetak = 'belum cetak'";
